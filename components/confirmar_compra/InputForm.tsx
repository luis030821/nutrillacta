        ...
        <div className="grid md:grid-cols-2 ">
          <div className="relative z-0 w-full mb-5 group">
            <input
              ...
              className="block py-2.5 px-3 bg-paleta-300 pb-3 w-full rounded-[6px] text-sm text-gray-900 bg-transparent border-[1px] border-paleta-300 appearance-none border-paleta-500/30 focus:border-paleta-200 focus:outline-none focus:ring-0  peer"
              placeholder=" "
              required
            />
            <label
